...
export const AiCourseDetailView: React.FC<AiCourseDetailViewProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in-50 duration-200" id={`course-detail-${course.id}`}>
      ...
      {/* ======================================================================= */}
      {/* SECTION 1: DETAILED SYLLABUS & MODULES */}
      {/* ======================================================================= */}
        ...
        <section id="section-course-syllabus" className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-slate-200">
            ...
            <span className="text-xs font-mono text-slate-500">
              {course.syllabus?.length || 4} Instructional Modules • Total Pace: {course.duration}
            </span>
          </div>
            ...
            {course.syllabus && course.syllabus.length > 0 ? (
              course.syllabus.map((mod: AiCourseModule) => (
                <div 
                  ...
                  className="bg-white rounded-2xl border border-slate-200 shadow-2xs hover:border-cyan-300 transition-all p-5 sm:p-6 space-y-4"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center space-x-3">
                      <span className="px-2.5 py-1 rounded-md text-xs font-mono font-bold bg-cyan-50 text-cyan-900 border border-cyan-200">
                    ...
                    <span className="inline-flex items-center space-x-1 px-2.5 py-0.5 rounded text-xs font-mono text-slate-600 bg-slate-100 self-start sm:self-auto">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs sm:text-sm text-slate-700">
                      {mod.topics.map((topic, tIdx) => (
                        <div key={tIdx} className="flex items-start space-x-2 bg-slate-50/70 p-2.5 rounded-xl border border-slate-100">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 pt-2">
                    <div className="p-3.5 rounded-xl bg-amber-50/60 border border-amber-200/80 text-xs text-amber-950 space-y-1">
                    ...
                    <div className="p-3.5 rounded-xl bg-emerald-50/60 border border-emerald-200/80 text-xs text-emerald-950 space-y-1">
